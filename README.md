...
![Hex.pm](https://img.shields.io/hexpm/l/apa) [![Download](https://api.bintray.com/packages/keryhu/maven/hospital-lib/images/download.svg?version=1.0.23)](https://bintray.com/keryhu/maven/hospital-lib/1.0.23/link) [![Build Status](https://secure.travis-ci.org/xvik/generator-gradle-plugin.png)](https://travis-ci.org/xvik/generator-gradle-plugin)
...
```
implementation 'com.sdrin.lib:hospital-lib:1.0.23'
```

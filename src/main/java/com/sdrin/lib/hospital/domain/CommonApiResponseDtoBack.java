 ...
 * @author 谢海波
 */
public enum CommonApiResponseDtoBack {
    OK("10000", "接口调用成功"),
    FAIL("20000", "服务不可用"),
    ...
    CommonApiResponseDtoBack(String code, String msg) {
        this.code = code;
        this.msg = msg;
    }
     ...
     * @return
     */
    public static CommonApiResponseDtoBack getByCode(String code) {
        for (CommonApiResponseDtoBack responseDto : values()) {
